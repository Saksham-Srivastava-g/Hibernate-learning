...
update(em);
   ...
   public static void insert(EntityManager em) {
    ...
    ts.begin();
    String sql = "INSERT INTO Student (eid, eaddress, ename) VALUES (?, ?, ?)";
    for (int i = 1; i < 11; i++) {
        Query nativeQuery = em.createNativeQuery(sql);
        nativeQuery.setParameter(1, 23 + i);      // eid
        nativeQuery.setParameter(2, "pandey");    // eaddress
        nativeQuery.setParameter(3, "banaras");   // ename
